...
var OutputData = function OutputData() {
  var _useState = (0, _react.useState)([]),
    ...
    freePlacesResp = _useState2[0],
    setFreePlacesResp = _useState2[1];
  (function () {
    var _setFreePlacesState = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            _context.t0 = setFreePlacesResp;
            _context.next = 3;
            return (0, _getFreePlaces.default)();
          case 3:
            _context.t1 = _context.sent;
            (0, _context.t0)(_context.t1);
            // Меняем состояние показа пустого блока, который показывается пока пользотель ничего не выбрал
            _outputData.default.changeShowEmptyBlock();
          case 6:
          case "end":
    ...
    function setFreePlacesState() {
      return _setFreePlacesState.apply(this, arguments);
    }
    return setFreePlacesState;
  })()();
  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(_core.ScrollArea, {
    h: 350,
    type: "always",
